...
})({"er9LX":[function(require,module,exports) {
"use strict";
...
var _pixabayAPI = require("./PixabayAPI");
const refs = {
...
const modalLightboxGallery = new (0, _simplelightboxDefault.default)(".gallery a", {
    captionDelay: 250
});
refs.btnLoadMore.classList.add("is-hidden");
const pixaby = new (0, _pixabayAPI.PixabayAPI)();
const options = {
    root: null,
    rootMargin: "100px",
    threshold: 1.0
};
const loadMorePhotos = async function(entries, observer1) {
    entries.forEach(async (entry)=>{
        if (entry.isIntersecting) {
            ...
            try {
                ...
                const markup = (0, _createMarkup.createMarkup)(hits);
                refs.gallery.insertAdjacentHTML("beforeend", markup);
                if (pixaby.hasMorePhotos) {
                    const lastItem = document.querySelector(".gallery a:last-child");
                    observer1.observe(lastItem);
                } else (0, _notiflixNotifyAio.Notify).info("We're sorry, but you've reached the end of search results.", notifyInit);
                modalLightboxGallery.refresh();
                scrollPage();
            } catch (error) {
                (0, _notiflixNotifyAio.Notify).failure(error.message, "Something went wrong!", notifyInit);
                clearPage();
            } finally{}
        }
    });
...
const onSubmitClick = async (event)=>{
    ...
    if (!search_query) {
        clearPage();
        (0, _notiflixNotifyAio.Notify).info("Enter data to search!", notifyInit);
    ...
    try {
        ...
        if (hits.length === 0) {
            (0, _notiflixNotifyAio.Notify).failure(`Sorry, there are no images matching your ${search_query}. Please try again.`, notifyInit);
            return;
        }
        const markup = (0, _createMarkup.createMarkup)(hits);
        refs.gallery.insertAdjacentHTML("beforeend", markup);
        pixaby.setTotal(total);
        (0, _notiflixNotifyAio.Notify).success(`Hooray! We found ${total} images.`, notifyInit);
        if (pixaby.hasMorePhotos) {
            const lastItem = document.querySelector(".gallery a:last-child");
...
//  smooth scrolling
function scrollPage() {
    const { height: cardHeight  } = document.querySelector(".photo-gallery").firstElementChild.getBoundingClientRect();
    window.scrollBy({
        top: cardHeight * 2,
        behavior: "smooth"
    });
...
function scrollFunction() {
    if (document.body.scrollTop > 15 || document.documentElement.scrollTop > 15) refs.btnUpWrapper.style.display = "flex";
    else refs.btnUpWrapper.style.display = "none";
}
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./createMarkup":"dMjm4","./PixabayAPI":"7sSNr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"kaxSc":[function() {},{}],"dMjm4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createMarkup", ()=>createMarkup);
function createMarkup(photos) {
    return photos.map(({ tags , webformatURL , largeImageURL , likes , views , comments , downloads ,  })=>{
        return /*html*/ `
...
},{}],"7sSNr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PixabayAPI", ()=>PixabayAPI);
...
class PixabayAPI {
    ...
    async getPhotos() {
        ...
        const { data  } = await (0, _axiosDefault.default).get(urlAXIOS, {
            params
        });
        return data;
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["er9LX","k9FoL"], "k9FoL", "parcelRequired7c6")
